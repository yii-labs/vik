...
use vik_workflow::{ServiceConfig, WorkflowReloader, load_effective_workflow};
...
async fn run_foreground(args: StartArgs) -> Result<(), Box<dyn Error>> {
...
mod tests {
    ...
    fn start_args_preserve_foreground_options() {
        ...
        let options: StartOptions = StartArgs {
