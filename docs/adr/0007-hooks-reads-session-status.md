...
2. Spawn and wait for the session, which holds the runtime Issue Stage context.
...
exposes state and snapshots. It does not know hook types. The hooks module
renders shell bodies and reports hook outcomes. It does not own session
lifecycle.
